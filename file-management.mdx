...
| **Batch rename** | Select multiple files and rename with a pattern |
| **Auto-organize** | Sort files into subfolders by type, date, or content |
| **Smart classification** | Agent tags files based on their content |
...
- **Read** — reads file contents into its context.
- **Write** — creates or overwrites files.
- **Edit** — makes targeted edits to specific lines or sections.
- **Delete** — deletes files (with approval in Work Along mode).
