...
description: "Desktop app settings — appearance, models, channels, and runtime connection"
---

# HeadmasterUI Settings

These are the settings you configure in the Headmaster desktop app itself. They control how the app looks, which models you connect to, and how the app talks to the runtime engine.
